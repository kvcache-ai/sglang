...
# The fused_marlin_moe module will be imported when needed in the apply() method
...
class CompressedTensorsWNA16MoEMethod(CompressedTensorsMoEMethod):
    ...
    def apply(
        ...
        output = fused_marlin_moe(
            ...
            routed_scaling_factor=self.moe_runner_config.routed_scaling_factor, # TODO: need to check scaling factor issue
        )
        return StandardCombineInput(hidden_states=output)
