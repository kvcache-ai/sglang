...
from sglang._vendor.compressed_tensors.quantization.utils import is_module_quantized
...
def infer_module_format(
    ...
    from sglang._vendor.compressed_tensors.compressors import BaseCompressor
