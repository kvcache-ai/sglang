...
from sglang._vendor.compressed_tensors.offload.module import offload_module, remove_module_offload
from sglang._vendor.compressed_tensors.offload.utils import (
    get_module_device,
    get_module_sizes,
    module_size,
)
from sglang._vendor.compressed_tensors.utils import getattr_chain
from sglang._vendor.compressed_tensors.utils.binary_search import SearchFailureError, max_binary_search
from sglang._vendor.compressed_tensors.utils.helpers import deprecated
...
def get_device_map(
    ...
    """
    from sglang._vendor.compressed_tensors.offload import get_execution_device, get_offloaded_device
