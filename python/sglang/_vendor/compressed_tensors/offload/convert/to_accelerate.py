...
import torch
from sglang._vendor.compressed_tensors.offload.cache import DiskCache, OffloadCache
from sglang._vendor.compressed_tensors.offload.convert.helpers import (
    DEFAULT_OFFLOAD_DEVICE,
    get_tensors,
    norm_device,
)
from sglang._vendor.compressed_tensors.offload.module import remove_module_offload
...
def _to_accelerate_disk_index(
    ...
    from sglang._vendor.compressed_tensors.offload import disable_onloading  # circular dependency
