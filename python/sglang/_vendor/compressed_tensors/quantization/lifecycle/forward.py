...
import torch
from sglang._vendor.compressed_tensors.quantization.lifecycle.forward_helpers import (
    _apply_quantize_op,
    _process_block,
    _process_group,
)
from sglang._vendor.compressed_tensors.quantization.quant_args import (
    DynamicType,
    QuantizationArgs,
    QuantizationStrategy,
)
from sglang._vendor.compressed_tensors.quantization.quant_config import QuantizationStatus
from sglang._vendor.compressed_tensors.quantization.quant_scheme import QuantizationScheme
from sglang._vendor.compressed_tensors.quantization.utils import (
    calculate_range,
    compute_dynamic_scales_and_zp,
)
from sglang._vendor.compressed_tensors.utils import patch_attr
